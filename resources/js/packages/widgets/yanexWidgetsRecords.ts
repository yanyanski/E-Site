...
export class YanexWidgetRecords{
    public static yanexWidgetDataAttrName: string = "yanexWidget";
    public static yanexWidgetDataAttrValuePrefix: string = "yanex-widget-id-";
